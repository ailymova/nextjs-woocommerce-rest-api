        ...
        <div className="flex justify-between flex-col h-full">
          ...
          <footer className="cart-product-footer flex justify-between p-4 border-t border-brand-bright-grey">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <button className="decrement-btn text-24px" onClick={event => handleQtyChange(event, item?.cartKey, 'decrement')}>
                -
              </button>
              <input
                type="number"
              ...
              />
              <button className="increment-btn text-20px" onClick={event => handleQtyChange(event, item?.cartKey, 'increment')}>
                +
              </button>
            </div>
          </footer>
