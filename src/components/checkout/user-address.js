...
function Address({ input, countries, states, handleOnChange, isFetchingStates, isShipping }) {
  const { errors } = input || {};
  ...
  return (
    <>
      ...
      />
      {/* State */}
      <StateSelection input={input} handleOnChange={handleOnChange} states={states} isShipping={isShipping} isFetchingStates={isFetchingStates} />
